...
// const result = first()
// 참조되어있기 때문에 가비지 컬렉터가 수집해가지 않음

// result에 할당된 second 함수때문에 first 함수가 생성한 환경 자체를 기억하는 것
// 함수는 태어난 환경을 기억하는데 그래서 second가 튀어나가도 second는 태어난 환경인 first속의 변수 x를 기억한다.

// 함수가 함수를 내보내는 게 클로저가 아님!
// 안쪽에 있는 대상이 바깥쪽을 사용해야 클로저?
// 클로저는 성능측면에서 문제가 있을 수 있음 

// 클로저를 쓰는 이유? => 문법 자체가 더 쉬워서??
